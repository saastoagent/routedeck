...
export const generatedObjectDescriptors = Object.freeze({
  ...
  InspectionPayload: Object.freeze({
    required: Object.freeze(["agent_context", "blocked_operations", "capabilities", "current_node", "diagnostics", "guard_explanations", "invocation_traces", "legal_operations", "reachable_nodes", "route_traces", "surfaces"]),
    optional: Object.freeze([]),
    additionalProperties: false,
    defaults: Object.freeze({}),
  }),
