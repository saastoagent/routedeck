# RouteDeck Context - Before Public Source Closeout

Archived on 2026-07-21 before recording the GitHub publication and first green
public CI run. The content below is the prior restart snapshot.
