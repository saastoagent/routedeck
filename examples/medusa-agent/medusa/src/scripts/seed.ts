// Adapted from medusajs/medusa-starter-default (MIT) for the protected RouteDeck demo.
      ...
      products: [
        {
          ...
          category_ids: [
            categoryResult.find((category) => category.name === "Shirts")!.id,
          ],
          description:
        ...
        },
        {
          ...
          category_ids: [
            categoryResult.find((category) => category.name === "Sweatshirts")!
              .id,
          ],
          description:
        ...
        },
        {
          ...
          category_ids: [
            categoryResult.find((category) => category.name === "Pants")!.id,
          ],
          description:
        ...
        },
        {
          title: "Medusa Shorts",
          category_ids: [
            categoryResult.find((category) => category.name === "Merch")!.id,
          ],
          description:
